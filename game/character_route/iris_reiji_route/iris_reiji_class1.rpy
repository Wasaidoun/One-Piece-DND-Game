...
label iris_reiji_class1:
    ...
    player "I decide to sit behind the couple, taking the seat behind the man" 
    ...
    menu:
        "\"My name is [player_name]\"":
            ...
            "The man looks up and sounds out my name before looking back at me with his smirk"
            reiji_unknown "\"ha\""
            reiji_unknown "\"Names-\""
    ...
    if player_pronouns != "female":
        player "I notice the blonde woman staring daggers at me"
    ...
    "Reiji ruffles Iris's hair and laughs. While Iris crossing her arms and pouts at him, muttering something I can't quite hear clearly"
