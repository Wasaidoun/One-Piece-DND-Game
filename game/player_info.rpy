label player_info:
    ...
    player "\"My name is [player_name]. It's good to meet you professor Fenton.\""

    fenton "Mix mix swirl mix, [player_name]. What do yer pronouns be? Fenton will remember them for you."

    player "Wow, for being a weird little guy he sure is respectful. I guess I should tell him my pronouns."
    ...
    player "I go by [player_pronouns] pronouns. Thank you fo-"
    ...
    player "W-what does he mean by that? I guess I should get to class now. I don't want to be late on my first day."
